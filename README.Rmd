...
`{camcorder}` is an an R package to track and automatically save graphics generated with `{ggplot2}` that are created across one or multiple sessions with the eventual goal of creating a gif showing all the plots created sequentially.
...
<tr>
<td>
<p><i>Cédric Scherer<br><a href = 'https://twitter.com/cedscherer/status/1281653392859820032'>TidyTuesday 2020/28</a></i></p>
<img src = "man/figures/cscherer_coffee_ratings.gif" height = "350">
</td>
<td>
<p><i>Georgios Karamanis<br><a href = 'https://mobile.twitter.com/geokaramanis/status/1248147973206413312'>TidyTuesday 2020/15</a></i></p>
...
Once the recorder is initialized, any ggplot that is made and printed will be automacically (or *automagically*) recorded.
...
ggplot(mtcars, aes(x = mpg, y = hp)) + 
  ...
  theme(
    ...
    panel.background = element_rect(colour = "turquoise")
  )
